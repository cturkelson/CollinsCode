...
/**
 * Project 1:
 * Test written by Collin Turkelson and Meghan Harris
 *
 *
 ...
 */
public class Signed16BitAdderTest {


  // The complete list of integers to be tests.
  // (IMPORTANT !!! You need to add to this list !!!)
  // We are testing the bounds of the carryouts in each full adder, with an additional test of propagation to test our 
  // look aheads ability to find carryouts.
  public static final long testIntegers[] = {-32768, -10922, -4095, -2730, -1365, -255, -170, -85, -15, -10, -5, 32767, 21845, 4095, 2730, 1365, 255, 170, 85, 15, 10, 5};
